...
public class TestFileAdaptersClient {
    ...
    public static void main(String[] args) {
        ...
        ResultRequest<String> dataClientFile = fileManager.read("c:\\files\\client\\client_25_02_2021_18_42_23.json");
        if (dataClientFile.failed()) {
            ...
            if (clientUnserialized.failed()) {
                ...
                dataClientFile = fileManager.read("c:\\files\\client\\client_25_02_2021_18_46_41.xml");
                if (dataClientFile.failed()) {
                    System.out.println(dataClientFile.getError());
                } else {
                    dataClient = dataClientFile.getValue();
                    ...
                    if (clientUnserialized.failed()) {
                        ...
                        dataClientFile = fileManager.read("c:\\files\\client\\client_25_02_2021_18_48_53.xml");
                        if (dataClientFile.failed()) {
                            System.out.println(dataClientFile.getError());
                        } else {
                            dataClient = dataClientFile.getValue();
